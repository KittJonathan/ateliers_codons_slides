...
Prenez dès maintenant l'habitude de commenter vos scripts. Cela les rendra plus compréhensibles - pour vous et pour vos collègues !

Vous pouvez également utiliser les commentaires pour créer un **en-tête** :
...
Structurez vos scripts à l'aide d'un commentaire suivi de **quatre tirets `-`**

-   Créez deux sections dans votre script
