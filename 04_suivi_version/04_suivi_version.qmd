...
![](img/git_branch_02.png){fig-align="left"}

![](img/git_branch_03.png){fig-align="left"}
...
![](img/git_branch_04.png){fig-align="left"}
...
![](img/git_branch_05.png){fig-align="left"}
...
![](img/git_branch_06.png){fig-align="left"}
...
![](img/git_branch_07.png){fig-align="left"}
...
![](img/git_branch_10.png){fig-align="left"}
...
![](img/git_branch_08.png){fig-align="left"}

## Fusionner les branches

<br>

Pour "rapatrier" sur la branche principale les modifications apportées sur une autre branche, procédez de la manière suivante :

-   placez-vous sur la branche dans laquelle vous voulez inclure les modifications (à l'aide de `git switch)`

-   utilisez la commande `git merge <name>` pour inclure les modifications

<br>

![](img/git_branch_09.png){fig-align="left"}

## Fusionner les branches

<br>

![](img/git_branch_13.png){fig-align="left"}

## Fusionner les branches

<br>

![](img/git_branch_11.png){fig-align="left"}
...
![](img/git_branch_12.png){fig-align="left"}
...
![](img/merge_vs_rebase_01.png){fig-align="left"}

## `git merge` vs `git rebase`

<br>

![](img/merge_vs_rebase_02.png){fig-align="left"}

## `git merge` vs `git rebase`

<br>

![](img/merge_vs_rebase_03.png){fig-align="left"}

## `git merge` vs `git rebase`

<br>

![](img/merge_vs_rebase_04.png){fig-align="left"}

## `git merge` vs `git rebase`

<br>

![](img/merge_vs_rebase_05.png){fig-align="left"}

## `git merge` vs `git rebase`

<br>

![](img/merge_vs_rebase_06.png){fig-align="left"}

## `git merge` vs `git rebase`

<br>

![](img/merge_vs_rebase_07.png){fig-align="left"}

## `git merge` vs `git rebase`

<br>

![](img/merge_vs_rebase_08.png)

## `git merge` vs `git rebase`

<br>

![](img/merge_vs_rebase_09.png){fig-align="left"}

## `git merge` vs `git rebase`

<br>

![](img/merge_vs_rebase_10.png){fig-align="left"}

## `git merge` vs `git rebase`

<br>

![](img/merge_vs_rebase_11.png){fig-align="left"}

## `git merge` vs `git rebase`

<br>

![](img/merge_vs_rebase_12.png){fig-align="left"}

## `git merge` vs `git rebase`

<br>

![](img/merge_vs_rebase_13.png){fig-align="left"}
...
Créons un fichier avec du contenu :
...
`git commit -m "texte A dans file1 sur branche master"`

## Les conflits

<br>

Créons une nouvelle branche et modifions le contenu du fichier sur cette branche :
...
Notez que les deux commandes ci-dessus peuvent être regroupées :

`git switch -c feat` (`-c` pour create)

<br>

`echo "texte B" > file1`

`git commit -am "texte B dans file1 sur branche feat"`

## Les conflits

<br>

Revenons sur la branche **master** et ajoutons du contenu :
...
`git commit -am "texte C dans file1 sur branche master"`

## Les conflits

<br>

Essayons de "rapatrier" la branche feat à l'aide d'un merge :
...
![](img/merge_conflict_01.png){fig-align="left"}

## Les conflits

<br>

Ouvrons le fichier contenant le conflit :

<br>

![](img/merge_conflict_02.png){fig-align="left"}

## Les conflits

<br>

Corrigeons le texte pour résoudre le conflit et sauvegardons les modifications :

![](img/merge_conflict_03.png){fig-align="left"}

<br>

`git add file1`

`git commit -m "resolution de conflit dans file1 sur branche master"`
